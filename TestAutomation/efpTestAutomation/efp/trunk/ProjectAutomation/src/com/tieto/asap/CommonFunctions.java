...
public class CommonFunctions {
	...
	public  CommonFunctions()
	{
		...
		if (asapDriver.fGetPlatform().equals("Android")){
			...
			System.out.println(asapDriver.fGetPlatform());
		}
		else
...
*/		
  ...
  //*****************************************************************************************
    ...
    public boolean fGuiScroll(){
    	System.out.println("Intoscroll");
    	Dimension dimensions = ((IOSDriver)driver).manage().window().getSize();
		Double screenHeightStart = dimensions.getHeight() * 0.5;
		int scrollStart = screenHeightStart.intValue();
		Double screenHeightEnd = dimensions.getHeight() * 0.2;
		int scrollEnd = screenHeightEnd.intValue();
		((IOSDriver) driver).swipe(0,scrollStart,0,scrollEnd,2000);
    	return true; 	
    }
  ...
  //*****************************************************************************************
    ...
    //*	Return Values	: Webelement - Webelement based on the description
    //*****************************************************************************************		
    /*public AndroidElement getObjectAndroid(String objDesc)
    {
        //Delimiters
        String[] delimiters = new String[] {":="};
        String[] arrFindByValues = objDesc.split(delimiters[0]);
  ...
  //*****************************************************************************************
    ...
    public void fGuiLongPress(String strDesc ){
    	...
    	{
    	  press=  driver.findElement(By.id(val));
    	}*/
    	
    	
	
	    /*    String abc=new String("new UiScrollable(new UiSelector().scrollable(true)"
	...
	public boolean fGuiSwipe(String homePhoneNo) {
		// TODO Auto-generated method stub
		return false;
	}

	/*public void fGuiSwipe() {
  ...
  /*  public boolean fGuiBackPress(){
	...
	public boolean scrollTo(String value ){
		while(((IOSDriver) driver).findElements(By.xpath(value)).size()==0)
		{
