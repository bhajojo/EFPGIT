...
public class TransactionServicesParametrizedTestNG {
	...
	{		
		...
		if (AccNum.equalsIgnoreCase("23306607123450"))
		{
			Assert.assertEquals(Items.size(),11);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123457"))
		{
			Assert.assertEquals(Items.size(),2);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123451"))
		{
			Assert.assertEquals(Items.size(),5);
		}
		
		
		if (AccNum.equalsIgnoreCase("23306607123456"))
		{
			Assert.assertEquals(Items.size(),56);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123458"))
		{
			Assert.assertEquals(Items.size(),7);
		}		
		
		
		if (AccNum.equalsIgnoreCase("23306607123453"))
		{
			Assert.assertEquals(Items.size(),15);
		}
		
				
		if (AccNum.equalsIgnoreCase("23306607123454"))
		{
			Assert.assertEquals(Items.size(),4);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123455"))
		{
			Assert.assertEquals(Items.size(),5);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123459"))
		{
			Assert.assertEquals(Items.size(),1);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123452"))
		{
			Assert.assertEquals(Items.size(),14);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123460"))
		{
			Assert.assertEquals(Items.size(),4);
		}
		
		if (AccNum.equalsIgnoreCase("23306607123461"))
		{
			Assert.assertEquals(Items.size(),18);
		}
