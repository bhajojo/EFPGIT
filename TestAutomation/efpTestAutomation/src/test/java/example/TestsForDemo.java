...
//  {
//	  System.out.println("Before Class Test For MyPages");
//	  	
...
//   {
//	   System.out.println("Login into MyPages");		   
//	   
...
//		HomePage.VerifyMoreTransactionLink();
//		HomePage.VerifyCreditDashBoardObjects();		 
//		HomePage.VerifyCreditDashBoardLink();
//		
...
//		
//			//Verify the Credit Limit Page
//			MyPagesDueDateChange VerifyPage = new MyPagesDueDateChange();
//			
//			Assert.assertTrue(VerifyPage.OpenDueDateChangePage());
//			Assert.assertTrue(VerifyPage.VerifyDueDateChangePage());
//			Assert.assertTrue(VerifyPage.VerifyDueDateMailSent());
//			
//		}
//   
//   @Test (priority=8, enabled=false)
//   public void VerifyApplyForNewProduct()
//   {
//	   		System.out.println("Login into MyPages");		   
//	   
//	   		//Create object of Launch Application	 class
...
//		
//			//Verify the Appl
//			MyPagesApplyForNewProduct VerifyApplyForNewProductPage = new MyPagesApplyForNewProduct();
//			
//			Assert.assertTrue(VerifyApplyForNewProductPage.OpenApplyNewProductPage());
//			Assert.assertTrue(VerifyApplyForNewProductPage.VerifyApplyNewCardsPage());
//			Assert.assertTrue(VerifyApplyForNewProductPage.VerifyEachButtonFunctionality());
//			
//		}
//   
//   
//   @Test (priority=8, enabled=true)
//   public void VerifyInstallmentFreeMonth()
//   {
//	   		System.out.println("Login into MyPages");		   
//	   
//	   		//Create object of Launch Application	 class
...
//			MyPagesLogin.loginAktiaBank();			
//		
//			//Verify the Installment Free Months
//			MyPagesInstalmentFreeMonth VerifyInstallmentFreeMonth = new MyPagesInstalmentFreeMonth();
//			
//			Assert.assertTrue(VerifyInstallmentFreeMonth.OpenInstalmentFreemonth());
//			Assert.assertTrue(VerifyInstallmentFreeMonth.VerifyInstalmentFreeMonth());
//			//Assert.assertTrue(VerifyInstallmentFreeMonth.VerifyEachButtonFunctionality());
//			
//		}
//   
//      
//   @Test(enabled=false)
//	 public void VerifyAllLogin()
//	 {	   		   
//	   	MyPagesHomePage login = new MyPagesHomePage();
//		
//		//login.loginNordeaBank();
//	   	
//	   	//Create object of Launch Application	 class
//		LaunchApplication launchApplication = new LaunchApplication();
//		
...
//		launchApplication.openApplication();
//		
//		login.LoginBankAlandan();
////		login.LoginBankPOPPanniki();
////		login.LoginBankOP();
////		login.LoginBankOMASP();
////		login.LoginBankSPanki();
//	    		   	
//	 }  
//   
//  
